...
class EtudiantForm(FlaskForm):
    ...
    niveau = SelectField("Niveau",choices=['1ère année','2ème année','Licence 1','Licence 2','Licence 3'],coerce=str)
    antenne = SelectField("Antenne",choices=['ABIDJAN','BOUAKE','ABOISSO','KORHOGO',"ABENGOUROU","DALOA"],coerce=str)
