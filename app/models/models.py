...
class EtudiantControle(baseModel,db.Model):
    __tablename__ = "etudiants_cotrole"
    __table_args__ = (
        db.UniqueConstraint('matricule', 'date_naissance', name='etudiant_controle_unique'),
    )
    nom = db.Column(db.String(255))
    prenoms = db.Column(db.String(255))
    matricule = db.Column(db.String(255))
...
class EtudiantVerif(baseModel,db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint('matricule', 'date_naissance', name='etudiants_verif_unique'),
    )
    nom = db.Column(db.String(255))
    prenoms = db.Column(db.String(255))
    matricule = db.Column(db.String(255))
